				...
				<div class="login-sec-bg">
					...
					<form method="POST" id="example-advanced-form" action="input_registration" style="display: none;" enctype="multipart/form-data">
						...
						<fieldset class="form-input">
							...
							<input id="current_address" name="current_address" type="text" class="form-control ">
							<label for="current_hp">3. Phone / HP  *</label>
							<input id="current_hp" name="phone_current_address" type="text" class="form-control ">
							...
							<input id="permanent_hp" name="phone_permanent_address" type="text" class="form-control ">
							<label for="place_date_birth">6. Place and Date of Birth  *</label>
							<input id="place_date_birth" name="place_date_birth" type="text" class="form-control ">
							<label for="age">7. Age  *</label>
							<input id="age" name="age" type="text" class="form-control ">
							<label for="nationality">8. Religion / Belief  *</label>
							<input id="nationality" name="religion" type="text" class="form-control ">
							...
							<input id="ethnic" name="ethnic" type="text" class="form-control ">
							<br>
							<h4># Family Condition</h4>
							<label for="name">1. Marital status *</label>
							<select id="age" name="marital_status" class="form-control ">
								<option value="">Choose</option>
							...
							<input id="surname" name="year_married" type="text" class="form-control ">
							...
							<table style="border-collapse: collapse; border-spacing: 0;">
								...
								<td><select id="age" name="sex_wife_husband" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_first_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_second_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_third_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
							...
							<table style="border-collapse: collapse; border-spacing: 0;">
								...
								<td><select id="age" name="sex_father" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_mother" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_your_first_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_name_your_second_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_your_third_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_your_fourth_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
								...
								<td><select id="age" name="sex_fifth_child" class="form-control ">
								<option value="">Choose</option>
								<option value="M">Male</option>
								<option value="F">Female</option>
							</select></td>
							...
							<input id="current_address" name="year_from_1" type="text" class="form-control ">
							<label for="current_hp">b. Year (till)  *</label>
							<input id="current_hp" name="year_till_1" type="text" class="form-control ">
							<label for="permanent_address">c. Name and Address of Employer *</label>
							<textarea id="permanent_address" name="name_address_employer_1" class="form-control "></textarea>
							<label for="permanent_hp">d. Phone  *</label>
							<input id="permanent_hp" name="phone_name_address_employer_1" type="text" class="form-control ">
							<label for="place_date_birth">e. Position  *</label>
							<input id="place_date_birth" name="position_1" type="text" class="form-control ">
							<label for="age">f. Do you have resignation plans:  *</label>
							<select id="age" name="resignation_plans" class="form-control ">
								<option value="">Choose</option>
							...
							<input id="name" name="hobbies" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<label for="surname">2. Organizational activities *</label>
							<input id="surname" name="organizational_activities" type="text" class="form-control ">
							<table style="border-collapse: collapse; border-spacing: 0;">
								<tr>
							...
							<input id="name" name="experiences_leader_1" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<input id="name" name="experiences_leader_2" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<br>
							<h4># Other Information</h4>
							<label for="name">1. Height *</label>
							<input id="name" name="height" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<label for="surname">2. Weight *</label>
							<input id="surname" name="weight" type="text" class="form-control ">
							...
							<select id="age" name="hospitalized" class="form-control ">
								<option value="">Choose</option>
								<option value="Never">Never</option>
								<option value="Yes">Yes</option>
							</select>
							<label for="name">Which year *</label>
							<input id="name" name="which_year" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<label for="surname">How long *</label>
							<input id="surname" name="how_long" type="text" class="form-control ">
							<label for="name">Diagnosis *</label>
							<input id="name" name="diagnosis" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							<label for="surname">Hospitalized in *</label>
							<input id="surname" name="hospitalized_in" type="text" class="form-control ">
							...
							<input id="name" name="working_as" type="text" class="form-control " placeholder="Single / Married / Divorced / Widow / Widower">
							...
							<input id="surname" name="file_photo" type="file" class="form-control ">
							<label for="surname">Upload CV *</label>
							<input id="surname" name="file_cv" type="file" class="form-control ">
							<label for="surname">ID Card Number *</label>
							<input id="surname" name="id_card_number" type="text" class="form-control ">
